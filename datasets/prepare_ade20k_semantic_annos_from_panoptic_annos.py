...
if __name__ == "__main__":
    dataset_dir = os.path.join(os.getenv("DETECTRON2_DATASETS", "datasets"), "ADEChallengeData2016")
    for s in ["val", "train"]:
        separate_coco_semantic_from_panoptic(
            os.path.join(dataset_dir, "ade20k_panoptic_{}.json".format(s)),
            os.path.join(dataset_dir, "ade20k_panoptic_{}".format(s)),
